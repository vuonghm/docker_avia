...
#mappings in MYSQL database
my %org_hash=(
	'hg19'=>1,
	'hg18'=>1,
	'mm10'=>2
);
# print Dumper (\%org_hash);
...
sub getAVIA{
    ...
    foreach my $line(@arr){
    	...
    	# print $lineArr[3] ."(". $org_hash{$opt_v}. ")\n";
    	# print "isPublished=$lineArr[4]\n";
    	if ($lineArr[3] == $org_hash{$opt_v} || $lineArr[4]==2){
